...
#define TX_PACKET_SIZE (1 + 7 * sizeof(float))  // 1 header + 7 floats = 29 bytes

static uint8_t uart_tx_packet[TX_PACKET_SIZE];
volatile uint8_t uart_tx_ready = 1;  // Flag to track DMA completion
